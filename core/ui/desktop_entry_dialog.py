...
class DesktopEntryDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.app_name = "Smart File Duplicate Manager"
    ...
    def create_app_menu_entry(self):
        try:
            ...
            desktop_file = os.path.join(desktop_dir, "smart-file-duplicate-manager.desktop")
...
Type=Application
Name={self.app_name}
Comment=Smart File Duplicate Manager is an app for finding and managing duplicate files. It's written on Python using PyQt6.
Exec={exec_line}
Icon={self.icon_path if self.icon_path else 'system-run'}
Terminal=false
Categories=Utility;
StartupNotify=true
Keywords=manager;files;cleaner;
"""
        return content
